...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="http://localhost/wordpress/wp-content/themes/my_theme/assets/css/single-default.css">
    </head>
    <body>
            ...
            <div class="container-new-page">
                    ...
                    <div class="slide-contenedor">
                        ...
                        <div class="span-slider">
                            Источник: 
                            <span class="span-value"><?php echo get_the_author();?></span>
                        </div>
                        </div>
                    <?php } 
                        ...
                        <div class="share-container">
                            ...
                            <div class="shareds-container">
                                ...
                                <div class="share-options">
                                    <a href="https://vk.com/share.php?url=<?php the_permalink(); ?>"><img class="vk-share"
                                            src="http://localhost/wordpress/wp-content/uploads/2022/07/ic_vk.png"
                                            onClick="onClick()" alt="vkshare">
                                    </a>
                                    <a href="https://telegram.me/share/url?url=<?php the_permalink(); ?>"> <img
                                            class="tel-share"
                                            src="http://localhost/wordpress/wp-content/uploads/2022/07/ic_telegram.png"
                                            ...
                                            $i++; ?>
                                                <div class="new1 new">
                                                    ...
                                                    <div class="new-date">
                                                        ...
                                                        <?php if(has_category('announcement')){?>
                                                            <img class="logo-tema-new"
                                                                src="http://localhost/wordpress/wp-content/uploads/2022/07/ic_ictis_ads.png"
                                                                alt="" /><?php }
                                                                else{?><img class="logo-tema-new"
                                                                src="http://localhost/wordpress/wp-content/uploads/2022/07/ic_ictis.png"
                                                                alt="" /><?php }?>
...
<script src="http://localhost/wordpress/wp-content/themes/my_theme/assets/js/single-default.js"></script>
...
function muestraSlides(n) {
  ...
  if (barras.length !== 0 && barras.length !== 0){
    if (n > slides.length) {
        indice = 1;
    }
    if (n < 1) {
